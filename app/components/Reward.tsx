...
export default function Reward() {
  return (
    <section id="reward" className="w-full max-w-6xl px-6 py-24 relative flex flex-col items-center">
      ...
      <div className="text-center mb-16 z-10">
        <p className="text-[#c19d67] font-[family-name:var(--font-playfair)] italic mb-2">Reward</p>
        <h3 className="text-5xl font-[family-name:var(--font-playfair)]">Honor & Reward</h3>
      </div>
